...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'plengi' => [
            'driver' => 'mysql',
            'url' => env('PLENGI_DATABASE_URL'),
            'host' => env('PLENGI_DB_HOST', '127.0.0.1'),
            'port' => env('PLENGI_DB_PORT', '3306'),
            'database' => env('PLENGI_DB_DATABASE', 'forge'),
            'username' => env('PLENGI_DB_USERNAME', 'forge'),
            'password' => env('PLENGI_DB_PASSWORD', ''),
            'unix_socket' => env('PLENGI_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,

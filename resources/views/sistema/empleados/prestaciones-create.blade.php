<div id="create-prestaciones-component" style="content-visibility: auto; overflow: auto; display: none;">

    <div class="card mb-4">
        <div class="card-body">

            <form class="row" id="prestacionesForm">

                <input type="text" class="form-control" name="id_prestaciones_up" id="id_prestaciones_up" style="display: none;">

...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Mano de obra'])
        ...
        <div class="row" style="z-index: 9;">
            <div class="row" style="z-index: 9;">
                <div class="col-12 col-md-6 col-sm-6">
                    <button type="button" class="btn btn-success btn-sm" id="createManoObra">Agregar mano de obra</button>
                </div>
                <div class="col-12 col-md-6 col-sm-6">
            ...
            <div class="card mb-4" style="content-visibility: auto; overflow: auto;">
                <div class="card-body">
                    ...
                    @include('sistema.mano-obras.mano-obras-table')
    ...
    @include('sistema.mano-obras.mano-obras-form')
    ...
    <script type="text/javascript" src="assets/js/componentes/manoObras.js"></script>
